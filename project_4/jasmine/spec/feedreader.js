...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
         ...
         */
        it('checks urls are defined and not empty', () => {
         ...
         */
        it('checks names are defined and not empty', () => {
            allFeeds.forEach(feed => {
    ...
    describe('The menu', () => {
        ...
        it('menu changes visibility when icon is clicked', () => {
            ...
            // should toggle to be visible now:
            menuIcon.click();
            expect(body.hasClass('menu-hidden')).toBe(false);
            
            // click again, should go back to hidden:
            menuIcon.click();
            expect(body.hasClass('menu-hidden')).toBe(true);
        });
    });
    ...
    describe('New Feed Selection', () => {
        ...
        it('before and after should be different', (done) => {
